# agent.skills - Dog Walker App (React Native Expo)

project:
name: "Dog Walker"
type: "React Native Expo Mobile Application"
description: "A mobile app for connecting dog owners with dog walkers"
...
skills:
frontend_development: - Building React Native components - TypeScript type definitions - Expo SDK integration - React Navigation setup - Mobile UI/UX design patterns - Responsive layouts for mobile - Code quality with ESLint and Prettier - Testing with Jest - Code analysis with Codacy - Git workflow - Pull requests for code review - Merge to main after approval - Continuous integration with GitHub Actions - Version control with Git - Documentation with Markdown - ux design principles and best practices for mobile apps knowledge and user research and wireframing skills and prototyping tools experience (Figma, Sketch, Adobe XD) for creating app designs and user flows knowledge and user personas and journey mapping for understanding target audience and improving user experience.
